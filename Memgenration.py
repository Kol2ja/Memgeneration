...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        self.setWindowTitle('Ãåíåðàòîð ìåìîâ')

        self.btn = QPushButton('Çàãðóçèòü', self)
        self.btn.resize(self.btn.sizeHint())
        self.btn.move(500, 100)
        self.btn.clicked.connect(self.hello)

        self.btn = QPushButton('Ñäåëàòü ìåì', self)
        self.btn.resize(self.btn.sizeHint())
        ...
        self.name_inpu3 = QPushButton('Ñêà÷àòü ìåì', self)
        self.btn.resize(self.btn.sizeHint())
        self.name_inpu3.move(500, 400)

        self.name_inpu3 = QPushButton('Ïîëîæåíèå òåêñòà', self)
        self.btn.resize(self.btn.sizeHint())
        self.name_inpu3.move(500, 300)

        btn = QPushButton('Âûáðàòü øèðèôò', self)
        ...
        self.lbl = QLabel('Ïðèìåð òåêñòà', self)
